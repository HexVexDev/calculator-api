...
<table className='table'>
    ...
    {data.map((dat) => (
        ...
        vehicle_year={dat.vehicle_year} vehicle_price={dat.vehicle_price} vehicle_vin={dat.vehicle_vin} vehicle_make={dat.vehicle_make}
        vehicle_model={dat.vehicle_model}  />
    ))}
    </tbody>
</table>
